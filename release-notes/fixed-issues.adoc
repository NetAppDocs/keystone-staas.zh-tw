...
| 問題說明 | 修正之後 | 已於版本中修正 
 ...
 a| 
在 Digital Advisor 的「消費趨勢」標籤中，已開立發票的累計突發圖表在選擇不同日期範圍時，顯示同一計費週期的值各有不同。
 a| 
固定
 a| 
2026-08-31
 ...
 a| 
在 Digital Advisor 的「消費趨勢」標籤中，消費趨勢圖表不顯示當天的消費資料，只顯示前一天的資料。
 a| 
固定
 a| 
2026-08-10
 ...
 a| 
儘管實際使用量在允許的突發流量限制之內，Digital Advisor控制面板中訂閱的顯示狀態錯誤地顯示為「超出突發流量限制」。
 a| 
固定
 a| 
2026-03-30
