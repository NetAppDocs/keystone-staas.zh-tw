...
訂閱期間，您可以根據特定條件變更已承諾的容量。有關容量增加和減少規則的完整詳情，請參閱 link:../concepts/capacity-requirements.html["Keystone效能服務等級的容量要求"]。若要申請更改，請聯絡您的 Keystone Success Manager（KSM）或參閱 link:../concepts/support-services.html["NetApp Keystone 支援"]。
