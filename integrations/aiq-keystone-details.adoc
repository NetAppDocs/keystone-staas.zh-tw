...
[role="lead"]
Active IQ Digital Advisor （也稱為數位顧問）儀表板可讓您監控 NetApp Keystone 訂閱的使用情形、並產生報告。在訂購Keystone服務時、您可以在Digital Advisor儀表板上的* Keystone Subscriptions *（基礎概念訂閱）小工具上檢視訂閱與使用的詳細資料。
