...
* 雖然 Console 和Digital Advisor提供了一些獨家功能，但 Console 為Keystone提供了管理功能，讓您可以管理訂閱並進行必要的調整。欲了解更多信息，請參閱 link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html["NetApp Console中的Keystone存取角色"^]。
