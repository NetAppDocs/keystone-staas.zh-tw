...
+
您可以使用*隱藏/顯示欄*來新增或移除表格中顯示的欄。預設情況下，表格會顯示您先前儲存的欄偏好設定。新增的欄，例如*部門*或*總佔用空間*欄，預設為隱藏，需要手動選擇才能顯示在表格中。您可以選擇或取消選擇任何欄，您的偏好設定將被儲存以供日後使用。下載 CSV 報表時，無論您的顯示偏好設定為何，所有可用的欄都會包含在匯出檔案中。
